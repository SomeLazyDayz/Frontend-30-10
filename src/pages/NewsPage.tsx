...
export default function NewsPage() {
  const news = [
    ...
    {
      id: 2,
      title: 'BLOOD + đạt mốc 500 người đăng ký hiến máu',
      date: '10/10/2025',
      location: 'TP. Hồ Chí Minh',
      description: 'Chúng tôi vô cùng tự hào thông báo rằng BLOOD + đã đạt được mốc 500 người đăng ký hiến máu tình nguyện chỉ sau 3 tháng ra mắt. Cảm ơn sự ủng hộ của cộng đồng!',
    ...
    },
    {
      ...
      description: 'BLOOD + chính thức hợp tác với Bệnh viện Chợ Rẫy - một trong những bệnh viện lớn nhất TP.HCM, mở rộng mạng lưới kết nối giữa người hiến máu và các cơ sở y tế.',

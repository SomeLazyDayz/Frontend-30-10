    ...
    <div className="min-h-screen bg-[#FBF2E1]" style={{ fontFamily: 'Times New Roman, serif' }}>
      ...
      <main className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-center mb-12 text-4xl font-bold uppercase text-[#930511]">Giới thiệu về BLOOD +</h1>
          ...
          <section className="bg-white rounded-lg p-8 mb-8">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-lg">
                  BLOOD + ra đời với sứ mệnh kết nối những người hiến máu tình nguyện với các bệnh viện đang cần máu khẩn cấp tại TP.HCM. Chúng tôi tin rằng mỗi giọt máu đều có thể cứu sống một sinh mạng, và công nghệ có thể làm cho quá trình này nhanh chóng và hiệu quả hơn.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="flex items-start gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-lg mb-8">
                  BLOOD + được xây dựng bởi một nhóm các bạn trẻ đam mê công nghệ và hoạt động xã hội. Chúng tôi tin rằng sự kết hợp giữa công nghệ và lòng nhân ái có thể tạo ra những thay đổi tích cực cho cộng đồng.
                </p>
              </div>
            </div>
